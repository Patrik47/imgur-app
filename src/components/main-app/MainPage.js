...
class MainPage extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      prevState.mainSelectedOption !== this.state.mainSelectedOption ||
      prevState.alternativeSelectedOption !== this.state.alternativeSelectedOption
    ) {
      this.sortAndFilter();
    } else if (
      prevState.filteredPosts !== this.state.filteredPosts ||
      (prevState.posts.length !== 0 && this.state.posts.length === 0)
    ) {
      this.fetchData();
    }
  }
  ...
  fetchData = () => {
    let newPosts = this.state.filteredPosts.slice(
      this.state.startingPos,
      this.state.startingPos + 16
    );
  ...
  sortAndFilter = () => {
    if (
      this.state.mainSelectedOption === 'USER SUBMITTED' &&
      this.state.alternativeSelectedOption === 'POPULAR'
    ) {
      ...
      this.state.mainSelectedOption === 'USER SUBMITTED' &&
      this.state.alternativeSelectedOption === 'RISING'
    ) {
      ...
      this.state.mainSelectedOption === 'USER SUBMITTED' &&
      this.state.alternativeSelectedOption === 'NEWEST'
    ) {
      ...
      this.state.mainSelectedOption === 'HIGHEST SCORING' &&
      this.state.alternativeSelectedOption === 'TODAY'
    ) {
      ...
      this.state.mainSelectedOption === 'HIGHEST SCORING' &&
      this.state.alternativeSelectedOption === 'WEEK'
    ) {
      ...
      this.state.mainSelectedOption === 'HIGHEST SCORING' &&
      this.state.alternativeSelectedOption === 'MONTH'
    ) {
      ...
      this.state.mainSelectedOption === 'HIGHEST SCORING' &&
      this.state.alternativeSelectedOption === 'YEAR'
    ) {
      ...
      this.state.mainSelectedOption === 'HIGHEST SCORING' &&
      this.state.alternativeSelectedOption === 'ALL TIME'
    ) {
      ...
      this.state.mainSelectedOption === 'MOST VIRAL' &&
      this.state.alternativeSelectedOption === 'POPULAR'
    ) {
      ...
      this.state.mainSelectedOption === 'MOST VIRAL' &&
      this.state.alternativeSelectedOption === 'BEST'
    ) {
      ...
      this.state.mainSelectedOption === 'MOST VIRAL' &&
      this.state.alternativeSelectedOption === 'RANDOM'
    ) {
  ...
  render() {
    ...
    return (
      <div className="main-page">
        <Header
          openMain={this.state.openMainCoverOptions}
          openAlternative={this.state.openAdditionalCoverOptions}
          mainOption={this.state.mainSelectedOption}
          alternativeOption={this.state.alternativeSelectedOption}
          handleAlternativeOptionSelection={this.handleAlternativeOptionSelection}
          handleMainOptionSelection={this.handleMainOptionSelection}
          handleButtonClick={this.handleButtonClick}
          handleDropdownOptionsReset={this.handleDropdownOptionsReset}
          masonryLayout={this.state.masonryLayout}
          handleLayout={this.handleLayoutChange}
        />
        <Body
          posts={this.state.posts}
          more={this.state.isThereMore}
