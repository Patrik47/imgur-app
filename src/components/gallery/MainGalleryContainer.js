                ...
                <div className="gallery-content">
                    ...
                    <div className="gallery-comments-info">
                        <div className="gallery-comments-info-headline"> 
                            <span>{props.data.number_of_comments} Comments</span>
                        </div>
                        <div className="gallery-comments-info-expandall">
                        ...
                        <div className="gallery-comments-info-sort">
                            <div className="gallery-comments-info-dropdown-headline">
                                <span>Best</span>
                                <img className="iconChevronDown" src="https://s.imgur.com/desktop-assets/desktop-assets/chevron-down-w.c9d88e9dd4a2c859ee05.svg" width="15"></img>
                            </div>
