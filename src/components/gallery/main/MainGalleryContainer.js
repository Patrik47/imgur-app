              ...
              <div
                ...
                <svg
                  ...
                  <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M13.0004 8C13.0004 8.55229 12.5527 9 12.0004 9C11.4481 9 11.0004 8.55229 11.0004 8V5H8.00037C7.44808 5 7.00037 4.55228 7.00037 4C7.00037 3.44772 7.44808 3 8.00037 3H12.0004C12.5505 3 12.9969 3.44423 13.0003 3.99353L13.0004 4V8ZM3 8C3 7.44772 3.44772 7 4 7C4.55228 7 5 7.44772 5 8V11H8C8.55228 11 9 11.4477 9 12C9 12.5523 8.55228 13 8 13H4C3.44772 13 3 12.5523 3 12V8Z"></path>
                </svg>
              </div>
              <div
                className="gallery-comments-info-expandall"
              ...
              <div className="gallery-comments-info-sort">
                ...
                <div className="gallery-comments-info-dropdown-bottom" style={{ display: 'none' }}>
                  <svg
                    ...
                    <path
                      fill="#ffffff"
                      d="M10.3359 1.1094C11.3436 0.437601 12.6564 0.437601 13.6641 1.1094L24 8L3.05823e-09 8L10.3359 1.1094Z"></path>
                  </svg>
